...
doTestSuite: $(EXEC_PROD)
	java -jar ./Java/SolutionCalculator/solutionCalculator.jar --c "./C/$(EXEC_PROD)" --p "./Python/tabu_W_v3.py" --i "./Inputs/I_1_5_20_*.txt" --i "./Inputs/I_1_5_150_*.txt" --i "./Inputs/I_1_5_100_*.txt"
