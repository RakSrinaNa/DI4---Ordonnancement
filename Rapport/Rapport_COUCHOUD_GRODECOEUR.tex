...
;
	...
	\chapter{Résultats obtenus}
		...
		\begin{itemize}
			\item Maximum de 20000 itérations
		...
		\section{Comparaison avec le Python}
			...
			Sur les prochains graphiques, on montrera les différences de score par itération entre les deux programmes. La courbe bleue représente les résultats du C et la courbe orange ceux du Python. On n'affiche pas le nombre total d'itérations pour garder une échelle correcte (on s'arrête à la dernière amélioration). Nous préciserons le nombre d'itérations effectuées dans la description.
			...
			Le C trouve sa meilleure solution à la 39\ieme itération, tandis que le Python trouve la sienne à la 115\ieme. De plus, le code Python termine son exécution en ayant réalisé 74 itérations, alors que le code C a eu le temps d'en faire 4492. Enfin, notre programme trouve une solution avec un score de 4449, contre 4485 pour le Python.
			
			\imgr{5-50-1.png}{Instance à 5 machines et 50 tâches}{0.5}{instance2}
			
			Cette fois-ci (\autoref{instance2}), on remarque toujours un écart dès le début, cependant moins important que pour l'exemple précédent. En revanche, on constate déjà que le Python peine à travailler avec des instances de cette taille : il est limité par le temps avant de se stabiliser. À l'inverse, le C étant moins contrant par le temps, il arrive après une stabilisation à se diversifier pour trouver une solution encore meilleure. Le Python se termine après 17 itérations avec un score de 24376 ; le C, de son côté, obtient un score de 21563 après 718 itérations.
			...
			Les deux programmes n'ayant pas les même vitesses d'exécution, nous pouvons aussi comparer les scores par unité de temps. Pour montrer à quel point le programme C surpasse le Python, les exemples parlent d'eux-mêmes :
			
			\imgr{5-20-1-t.png}{Instance à 5 machines et 20 tâches}{0.5}{instance4}
			
			\imgr{5-50-1-t.png}{Instance à 5 machines et 50 tâches}{0.5}{instance5}
			
			\imgr{10-200-1-t.png}{Instance à 10 machines et 200 tâches}{0.5}{instance6}
			
			Même sur de grosses instances, le C atteint sa valeur finale alors que le Python n'a encore effectué qu'une poignée d'itérations. On pourrait limiter bien plus le nombre maximal d'itérations pour générer une solution plus rapidement.
			...
			\begin{itemize}
				\item Notre programme ne produit pas de solution initiale moins bonne que le programme Python.
	...
	\chapter{Autres}
		...
		\chapter{\label{exemplesGraphes}Résultats sur chaque type d'instance}
			...
			\img{5-20-1-t.png}{Instance à 5 machines et 20 tâches}{0.52}
			\img{5-50-1.png}{Instance à 5 machines et 50 tâches}{0.52}
			\img{5-50-1-t.png}{Instance à 5 machines et 20 tâches}{0.52}
			\img{5-100-1.png}{Instance à 5 machines et 100 tâches}{0.47}
			\img{5-100-1-t.png}{Instance à 5 machines et 100 tâches}{0.47}
			\img{5-150-1.png}{Instance à 5 machines et 150 tâches}{0.47}
			\img{5-150-1-t.png}{Instance à 5 machines et 150 tâches}{0.47}
			\img{5-200-1.png}{Instance à 5 machines et 200 tâches}{0.47}
			\img{5-200-1-t.png}{Instance à 5 machines et 200 tâches}{0.47}
			\img{10-20-1.png}{Instance à 10 machines et 20 tâches}{0.47}
			\img{10-20-1-t.png}{Instance à 10 machines et 20 tâches}{0.47}
			\img{10-50-1.png}{Instance à 10 machines et 50 tâches}{0.47}
			\img{10-50-1-t.png}{Instance à 10 machines et 50 tâches}{0.47}
			\img{10-100-1.png}{Instance à 10 machines et 100 tâches}{0.47}
			\img{10-100-1-t.png}{Instance à 10 machines et 100 tâches}{0.47}
			\img{10-150-1.png}{Instance à 10 machines et 150 tâches}{0.47}
			\img{10-150-1-t.png}{Instance à 10 machines et 150 tâches}{0.47}
			\img{10-200-1.png}{Instance à 10 machines et 200 tâches}{0.5}
			\img{10-200-1-t.png}{Instance à 10 machines et 200 tâches}{0.5}
\end{document}