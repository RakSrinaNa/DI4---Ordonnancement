...
void tabuListUnit()
{
	...
	if(tabuList_contains(list, item1))
		unit_error("TabuList 14: Tabu list should not contain the item1");
	if(!tabuList_contains(list, item2))
		unit_error("TabuList 15: Tabu list should contain the item2");
	if(!tabuList_contains(list, item2))
		unit_error("TabuList 16: Tabu list should contain the item3");
