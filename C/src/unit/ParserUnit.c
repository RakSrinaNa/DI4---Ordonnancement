...
void parserUnit()
{
	...
	if(instance1->machineCount != 3 || instance1->taskCount != 5)
		unit_error("Parser 5: Wrong machine or task count.");
	if(task_getDueDate(instance1->tasks[0]) != 10 || task_getDueDate(instance1->tasks[1]) != 20 || task_getDueDate(instance1->tasks[2]) != 30 || task_getDueDate(instance1->tasks[3]) != 40 || task_getDueDate(instance1->tasks[4]) != 50)
		unit_error("Parser 6: Wrong due date.");
	if(task_getMachineDuration(instance1->tasks[0], 0) != 1 || task_getMachineDuration(instance1->tasks[1], 0) != 2 || task_getMachineDuration(instance1->tasks[2], 0) != 3 || task_getMachineDuration(instance1->tasks[3], 0) != 4 || task_getMachineDuration(instance1->tasks[4], 0) != 5)
		unit_error("Parser 7.1: Wrong machine duration.");
	if(task_getMachineDuration(instance1->tasks[0], 1) != 6 || task_getMachineDuration(instance1->tasks[1], 1) != 7 || task_getMachineDuration(instance1->tasks[2], 1) != 8 || task_getMachineDuration(instance1->tasks[3], 1) != 9 || task_getMachineDuration(instance1->tasks[4], 1) != 10)
		unit_error("Parser 7.2: Wrong machine duration.");
	if(task_getMachineDuration(instance1->tasks[0], 2) != 11 || task_getMachineDuration(instance1->tasks[1], 2) != 12 || task_getMachineDuration(instance1->tasks[2], 2) != 13 || task_getMachineDuration(instance1->tasks[3], 2) != 14 || task_getMachineDuration(instance1->tasks[4], 2) != 15)
	...
	for(unsigned int i = 0; i < 6; i++)
		if(!unit_uintArrayEquals(correctMatrix2[i], instance1->distancesMatrix[i], 3))
